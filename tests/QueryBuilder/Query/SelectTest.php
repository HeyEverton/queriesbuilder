...
class SelectTest extends TestCase
{
    ...
    public function testIfQueryAllowsAddMoreConditionsInOurQueryWithWhere()
    {
        $query = $this->select->where('name', '=', ':name')
                              ->where('price', '>=', ':price');
    ...
    public function testIfQueryIsGeneratedWithJoinConditions()
    {
    ...
    public function testIfSelectQueryHasGeneratedWithMoreJoinsClausele()
    {
